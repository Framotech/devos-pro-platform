...
export default function ProjectsSection() {
  ...
  const projectPath = (project: Project) => `/projects/${project.slug || project._id}`;
  const openProject = (project: Project) => router.push(projectPath(project));
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: '3rem' }}>
        ...
        >
          <span
            style={{ width: '24px', height: '1px', background: 'var(--green)', display: 'block' }}
          />
          Deployed Containers
        </div>
        <div
            ...
            {['All', 'Running', 'Exited'].map((f) => (
              <button
                ...
                style={{
                  ...
                  borderRadius: '6px',
                  border:
                    filter === f ? '1px solid var(--border-green)' : '1px solid var(--border)',
        ...
        >
          {filtered.map((project, index) => (
            <div
              ...
              onMouseEnter={(e) => {
                router.prefetch(projectPath(project));
